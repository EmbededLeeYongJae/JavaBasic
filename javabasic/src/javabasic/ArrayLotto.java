 ...
 * - 사용자가 1 2 3 4 5 6 7 입력하고 프로그램에서 랜덤 추출한 숫자가 1 2 3 4 11 22 33  -> 4등 
 ...
 * 6. 과제 제출 방법
 * - 소스코드(java파일)의 실행결과 캡처 이미지 압축해서 realchoky@naver.com으로 이름써서 제출
 * 
 */
...
public class ArrayLotto {
	...
	public static void main(String[] args) {
		...
		// (int)(Math.randon()*45)+1 : 1~45 중 랜덤한 정수
		
		
		
		//중복제거가 안된 7개의 1~45 범위의 랜덤 정수
		for(int i = 0; i < 7; i++) {
