...
//		int i ;
		// i는 main 메서드 내에서 선언된 지역변수이므로 main메서드 밖에서는 사용할 수 있다.
		// i는 main 메서드의 지역변수이므로 초기화 후에만 사용할 수 있다.
		//System.out.println("선언 후 : " + i);
		// 초기화 (Initialization) : 변수에 값을 처음 할당(대입, 저장)
//		i = 100;
...
//		System.out.println(str11.trim());
		...
		// 실습 1) exerStr 문자열의 양쪽 공백을 제거해서 출력
